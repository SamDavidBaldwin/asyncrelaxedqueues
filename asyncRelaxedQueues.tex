...
% Specifically: lQueue.deqByPosition(pos,ts) does not return a value with later timestamp than ts, instead returning the element at index pos in the sublist of elements with timestamp preceding ts, or \bot if none such exists.
